...
export class UsersComponent implements OnInit {
  ...
  constructor(
    ...
    public router: Router) {
      ...
      else if(this.router.url.indexOf('tenants') > -1){
        this.userTypeId = 2;
      }
      else{
  ...
  async getUsers(){
    try{
      if(this.userTypeId === 1) {
        this.displayedColumns = ['id', 'username', 'fullName', 'role', 'email', 'mobileNumber', 'controls'];
        this.isLoading = true;
        ...
        this.displayedColumns = ['id', 'username', 'fullName', 'email', 'mobileNumber', 'controls'];
        this.isLoading = true;
        await this.userService.getTenantByAdvanceSearch({
          isAdvance: this.isAdvanceSearch,
          keyword: this.keywordCtrl.value,
          userId: this.userIdCtrl.value,
          email: this.emailCtrl.value,
