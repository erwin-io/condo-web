...
export class AuthService implements IServices {
  ...
  login(data: any): Observable<any> {
    const d = environment.apiBaseUrl;
    return this.http.post<any>(environment.apiBaseUrl + this.appconfig.config.apiEndPoints.auth.login.staff, data)
    .pipe(
  ...
  registerTenant(data: any): Observable<any> {
    return this.http.post<any>(environment.apiBaseUrl + this.appconfig.config.apiEndPoints.auth.register.tenant, data)
    .pipe(
